...
public class GetPoiFromCsvServiceValidation extends AbstractServiceValidationImpl {
	...
	public GetPoiFromCsvServiceValidation(String serviceId, String methodName, PersistenceEngine persistenceEngine) throws Exception {
		super(serviceId, methodName, persistenceEngine, "service/universiadi2013/validation-GetPoiFromCsv.xml");
		init();
	}
