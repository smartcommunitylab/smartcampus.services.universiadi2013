...
public class GetEventsServiceValidation extends AbstractServiceValidationImpl {
	...
	public GetEventsServiceValidation(String serviceId, String methodName, PersistenceEngine persistenceEngine) throws Exception {
		super(serviceId, methodName, persistenceEngine, "service/universiadi2013/validation-GetEvents.xml");
		init();
	}
