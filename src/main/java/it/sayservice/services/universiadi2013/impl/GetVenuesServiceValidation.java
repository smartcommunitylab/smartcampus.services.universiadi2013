...
public class GetVenuesServiceValidation extends AbstractServiceValidationImpl {
	...
	public GetVenuesServiceValidation(String serviceId, String methodName, PersistenceEngine persistenceEngine) throws Exception {
		super(serviceId, methodName, persistenceEngine, "service/universiadi2013/validation-GetVenues.xml");
		init();
	}
